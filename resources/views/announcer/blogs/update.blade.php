...
<div class="max-w-2xl mx-auto bg-white p-8 shadow-md rounded-md">
    <h2 class="text-2xl font-semibold text-gray-700 text-center">Update Blog</h2>

    <form class="mt-6" action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="space-y-6">
            <!-- Blog Image -->
            <div>
                <label class="text-sm font-medium text-gray-700">Blog Image</label>
                <input type="file" name="BlogImg" value="{{ $blog->getFirstMediaUrl('Blog_Image') }}">
            </div>

            <div class="mb-4">
                <label for="title" class="block text-sm font-medium text-gray-700">Title</label>
                <input type="text" id="title" name="title" required
                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md" value="{{ $blog->title }}">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" required
                    class="mt-1 p-2 block w-full border border-gray-300 rounded-md">{{ $blog->description }}</textarea>
            </div>
            <!-- Update Button -->
            <div>
                <button type="submit"
