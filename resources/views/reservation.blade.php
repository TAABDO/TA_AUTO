...
<body class="bg-gray-100 py-10">
    ...
    <div class="p-4 sm:ml-64">
        @foreach ($reservations as $reservation)
            <div class="flex flex-wrap bg-white shadow-lg rounded-lg overflow-hidden mb-4">
                <div class="w-full md:w-1/2 p-4">
                    <img src="{{ optional($reservation->announcements->first())->getFirstMediaUrl('images') }}" class="w-[20%]" alt="Car 1">
                </div>
                {{-- Car Information --}}

                <div class="w-full md:w-1/2 p-4">
                    <div class="text-gray-600"><span>Model:</span> {{ $reservation->model }}</div>
                    <div class="text-gray-600"><span>Type:</span> {{ $reservation->type }}</div>
                    <div class="text-gray-600"><span>km:</span> {{ $reservation->km }}mi</div>
                    <div class="text-gray-600"><span>Transmission:</span> {{ $reservation->transmission }}</div>
                    <div class="text-gray-600"><span>Engine_Capacity:</span> {{ $reservation->engine_capacity }}hp</div>
                </div>
