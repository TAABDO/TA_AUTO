...
<body class="bg-gray-100 font-sans">
    ...
    <!-- Navigation -->
    {{--  <nav
        class="bg-white dark:bg-white-700 bg-opacity-65 fixed w-full z-20 top-0 border-b border-gray-300 dark:border-gray-200">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 ml-20" id="navbar-cta">
                <ul
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 md:p-0 text-gray-700 rounded hover:bg-gray-100 "
