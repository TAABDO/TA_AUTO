            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="reservations"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Announcement Reserved</span>
                    </a>
                </li>
                <li class="mb-1 group">
                    <a href=""
                        ...
                        <span class="text-white text-body">My blogs </span>
                    </a>
                </li>
                <hr>
                <hr>
                <li>
                    ...
                    <a href="{{ route('AnnouncerProfile.index') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white hover:text-white">Profile</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('logout') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white text-body">Log Out</span>
                    </a>
                </li>
            </ul>
        </div>
    </aside>
    @elseif(Auth::user()->roles->pluck('name')->contains('Client'))
    <aside id="logo-sidebar"
      class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
     aria-label="Sidebar">
     <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
