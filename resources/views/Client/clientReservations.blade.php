...
<body class="bg-gray-100">
    ...
    <section id="reservation" style="visibility: visible"
        class="flex flex-wrap md:flex-row justify-center items-center py-10 ml-20 sm:py-10 md:py-12 lg:py-20 my-auto">
        @foreach ($reservations as $reservation)
            <div class="flex flex-col  md:flex-row bg-white shadow-lg rounded-lg m-4 w-full md:max-w-6xl">
                ...
                <div class="w-full gap-5 p-4 flex flex-row">
                    ...
                    <p class="text-gray-600 text-sm mb-2">isaccepted: {{ $reservation->status }}</p>
                    ...
                    <div class="part3 mt-4">
                        ...
                        <form action="{{ route('ClientReservations.destroy',$reservation->id) }}" method="post">
                            @csrf
                            @method('DELETE')
