    ...
    <ul class="space-y-2 font-medium">
        <li>
            <a href="#"
                ...
                <span class="ms-3 color-black">Dashboard</span>
            </a>
        ...
        <form class="mt-6" action="{{ route('brands.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="mt-1 w-full px-4 py-2 border rounded-md text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter brand name">
                </div>
