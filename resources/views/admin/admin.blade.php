            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div
                    ...
                    <div class="flex justify-between mb-4">
                        <div>
                            <div class="flex items-center mb-1">
                                <div class="text-2xl font-semibold">{{ $carAnnounceCount }}</div>
                                <div
                                    class="p-1 rounded bg-emerald-500/10 text-emerald-500 text-[12px] font-semibold leading-none ml-2">
                                    +30%</div>
                            </div>
                            <div class="text-sm font-medium text-gray-400">CarAnnounce</div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1">{{ $countblogs }}</div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($announces as $announce)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ \Illuminate\Support\Str::limit($announce->title, 30) }}</div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-500 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                                {{ \Illuminate\Support\Str::limit($announce->description, 50) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <img src="{{ $announce->getFirstMediaUrl('images') }}"
                                                alt="car Image">
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <button class="text-blue-500 hover:text-blue-700">
                                                <a href="{{ route('announceStatus.edit', $announce->id) }}">
                                                    <i class="fa-solid fa-pen"></i>
                                                </a>
                                            </button>
                                        </td>
