                            ...
                            <table class="items-center w-full bg-transparent border-collapse">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-100">
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ $user->name }}</td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ $user->status }}</td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{{ $user->roles()->first()->name }}</td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                         <button class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded "><a href="{{ route('admin.update',$user->id) }}"> Update </a></button>
                                         <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"><a href="{{ route('banuser',$user->id) }}"> Ban user </a></button>
                                        </td>
                                    </tr>
                                    @endforeach  --}}
                                    <tr class="text-gray-700 dark:text-gray-100">
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">name </td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">status </td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">rolesnam </td>
                                        <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                         <button class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded "><a href=""> Update </a></button>
                                         <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"><a href=""> Ban user </a></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                {{--  @foreach ($events as $event)  --}}
                                    <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1">
                                        ...
                                        <div class="border-t border-gray-200 px-6 py-4">
                                            ...
                                            <p class="text-gray-700 text-sm mb-2"><span class="font-semibold">Location:</span> location </p>
                                            <p class="text-gray-700 text-sm mb-2"><span class="font-semibold">Date:</span> date </p>
                                            <p class="text-gray-700 text-sm mb-2"><span class="font-semibold">Available Places:</span> availablePlaces </p>
                                            <p class="text-gray-700 text-sm mb-2"><span class="font-semibold">Category:</span> category</p>
